...
internal class ContentColumnRangeException(
    ...
    "Invalid column range entered: $inputRange in inventory owned by " +
    "${contents.inventory.holder ?: "nobody (static gui)"}. Inventory columns " +
    "must be between $DEFAULT_COLUMNS."
)